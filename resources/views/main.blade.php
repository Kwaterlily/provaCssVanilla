                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white titolissimo">
                                Documentation</h2>
                            <p class="titolissimo">hola</p>
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed titolissimo">
                            ...
                            <p class="titolissimo">123 prova</p>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white titolissimo">Vibrant
                                Ecosystem</h2>
